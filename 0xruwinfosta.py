...
def main():
    ...
    except (instaloader.exceptions.LoginRequiredException,instaloader.exceptions.LoginException) as url :
        print(Fore.RED + f"Login: Checkpoint required. Please complete the verification by visiting the following URL:")
        print(Fore.YELLOW + f"{url}")
        print(Fore.RED + "Follow the instructions in your browser, then retry the login.")
        return
    except Exception as e:
